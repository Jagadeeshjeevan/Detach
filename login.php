...
$ret= mysqli_query($con,"SELECT `aid`,pcId,username,user_type FROM trans_user WHERE username='$useremail' and password='$dec_password' ");
$num=mysqli_fetch_array($ret);

if($num>0)
{
$_SESSION['id']=$num['pcId'];
$_SESSION['name']=$num['username'];
$_SESSION['user_id']=$num['aid'];
